package ms.phecda.backend.rest.backend.modules.device.controller.impl;
...
import ms.phecda.backend.core.modules.device.service.bo.DeviceEventDataBO;
import ms.phecda.backend.core.modules.device.service.bo.DeviceExtBO;
import ms.phecda.backend.core.modules.device.service.bo.DevicePropertyDataBO;
import ms.phecda.backend.core.modules.device.service.bo.DeviceServiceDataBO;
...
import ms.phecda.backend.rest.backend.modules.device.controller.ro.DeviceEnabledRO;
import ms.phecda.backend.rest.backend.modules.device.controller.ro.DeviceProtocolUpdateRO;
...
import ms.phecda.backend.rest.backend.modules.device.support.DeviceConstants;
import ms.phecda.backend.rest.backend.modules.device.support.DeviceRestConvertMapper;
