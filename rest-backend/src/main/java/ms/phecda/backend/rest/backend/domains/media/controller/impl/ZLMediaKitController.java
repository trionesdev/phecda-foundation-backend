package ms.phecda.backend.rest.backend.domains.media.controller.impl;

import io.swagger.v3.oas.annotations.tags.Tag;
import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import ms.phecda.backend.core.domains.device.service.impl.DeviceService;
import ms.phecda.backend.rest.backend.domains.media.controller.ro.OnStreamNoneReaderRO;
import ms.phecda.backend.rest.backend.domains.media.controller.ro.OnStreamNotFoundRO;
import ms.phecda.backend.rest.backend.domains.media.controller.vo.OnStreamNoneReaderVO;
import ms.phecda.backend.rest.backend.domains.media.controller.vo.OnStreamNotFoundVO;
import org.springframework.web.bind.annotation.PostMapping;
import org.springframework.web.bind.annotation.RequestBody;
import org.springframework.web.bind.annotation.RequestMapping;
import org.springframework.web.bind.annotation.RestController;

import static ms.phecda.backend.rest.backend.domains.media.support.MediaConstants.MEDIA_URI;
