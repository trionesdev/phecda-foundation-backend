...
import com.trionesdev.phecda.foundation.core.domains.org.dao.impl.DepartmentDAO;
import com.trionesdev.phecda.foundation.core.domains.org.dao.impl.DepartmentMemberDAO;
import com.trionesdev.phecda.foundation.core.domains.org.dao.po.DepartmentMemberPO;
...
import com.trionesdev.phecda.foundation.core.domains.org.internal.OrgDomainConvert;
...
public class DepartmentServiceLocal implements DepartmentService {
    ...
    public List<OrgNodeDTO> orgListByDepartmentId(String departmentId) {
        ...
        if (CollectionUtil.isNotEmpty(departmentMembers)) {
            ...
            var members = tenantMemberManager.findMembersByUserIds(userIds);
            members.forEach(t -> {
                var name = t.getName();
