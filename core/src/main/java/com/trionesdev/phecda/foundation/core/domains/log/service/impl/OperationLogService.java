package com.trionesdev.phecda.foundation.core.domains.log.service.impl;

import com.google.common.collect.Lists;
import com.trionesdev.commons.context.actor.ActorRoleEnum;
import com.trionesdev.commons.core.page.PageInfo;
import com.trionesdev.commons.core.util.PageUtils;
import com.trionesdev.commons.model.Operator;
import com.trionesdev.phecda.foundation.core.domains.log.dao.criteria.OperationLogCriteria;
import com.trionesdev.phecda.foundation.core.domains.log.dao.po.OperationLogPO;
import com.trionesdev.phecda.foundation.core.domains.log.dto.OperationLogExtDTO;
import com.trionesdev.phecda.foundation.core.domains.log.internal.OperationLogConvert;
import com.trionesdev.phecda.foundation.core.domains.log.manager.impl.OperationLogManager;
import com.trionesdev.phecda.foundation.core.domains.org.dto.TenantMemberDetailDTO;
        ...
        return records.stream().map(record -> {
            ...
            if (Objects.equals(ActorRoleEnum.TENANT_MEMBER.name(), record.getActorRole())) {
                Optional.ofNullable(userMap.get(record.getActorId())).ifPresent(user -> {
                    operationLog.setOperator(Operator.builder().name(user.getNickname()).build());
                });
            } else {
                operationLog.setOperator(Operator.builder().name("运营人员").build());
            }
            return operationLog;
