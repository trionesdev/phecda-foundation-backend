package com.trionesdev.phecda.foundation.core.domains.user.manager.impl;
...
import com.trionesdev.phecda.foundation.core.domains.user.repository.impl.UserRepository;
...
public class UserManager {
    ...
    public Optional<User> findUserByAccount(User user) {
        ...
        if (Objects.equals(User.AccountType.PHONE, user.getAccountType())) {
