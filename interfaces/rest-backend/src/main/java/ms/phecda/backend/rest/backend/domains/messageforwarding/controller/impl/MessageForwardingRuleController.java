...
public class MessageForwardingRuleController {
    ...
    public MessageForwardingRule queryRuleById(@PathVariable(value = "id") String id) {
    ...
    public List<MessageForwardingRule> queryRules() {
    ...
    public List<MessageSink> findRuleSinks(@PathVariable(value = "id") String ruleId) {
