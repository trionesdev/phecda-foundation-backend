package com.trionesdev.phecda.backend.rest.backend.domains.notification.support;
...
import com.trionesdev.phecda.backend.rest.backend.domains.notification.controller.query.ContactGroupQuery;
import com.trionesdev.phecda.backend.rest.backend.domains.notification.controller.query.ContactQuery;
import com.trionesdev.phecda.backend.rest.backend.domains.notification.controller.query.NotificationTemplateQuery;
import com.trionesdev.phecda.backend.rest.backend.domains.notification.controller.ro.ContactCreateRO;
import com.trionesdev.phecda.backend.rest.backend.domains.notification.controller.ro.ContactGroupCreateRO;
import com.trionesdev.phecda.backend.rest.backend.domains.notification.controller.ro.ContactGroupUpdateRO;
import com.trionesdev.phecda.backend.rest.backend.domains.notification.controller.ro.ContactUpdateRO;
import com.trionesdev.phecda.backend.rest.backend.domains.notification.controller.ro.NotificationTemplateCreateRO;
import com.trionesdev.phecda.backend.rest.backend.domains.notification.controller.ro.NotificationTemplateUpdateRO;
