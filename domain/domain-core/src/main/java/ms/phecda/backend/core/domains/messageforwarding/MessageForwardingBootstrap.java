package ms.phecda.backend.core.domains.messageforwarding;

import lombok.RequiredArgsConstructor;
import ms.phecda.backend.core.domains.messageforwarding.event.redis.RuleChangeListener;
import ms.phecda.backend.core.domains.messageforwarding.event.redis.SinkActionChangeListener;
...
import static ms.phecda.backend.core.domains.messageforwarding.event.EventConstants.MESSAGE_FORWARDING_RULE_CHANGE;
import static ms.phecda.backend.core.domains.messageforwarding.event.EventConstants.MESSAGE_SINK_CHANGE;
