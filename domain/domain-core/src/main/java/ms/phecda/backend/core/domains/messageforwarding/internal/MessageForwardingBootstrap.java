...
import ms.phecda.backend.core.domains.messageforwarding.internal.event.redis.RuleChangeListener;
import ms.phecda.backend.core.domains.messageforwarding.internal.event.redis.SinkActionChangeListener;
...
import static ms.phecda.backend.core.domains.messageforwarding.internal.event.EventConstants.MESSAGE_FORWARDING_RULE_CHANGE;
import static ms.phecda.backend.core.domains.messageforwarding.internal.event.EventConstants.MESSAGE_SINK_CHANGE;
